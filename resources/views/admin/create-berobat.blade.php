    ...
    <div class="py-5">
        <div class="max-w-7xl mx-auto sm:px-6 max-sm:px-4 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mt-5">
                ...
                <form action="{{ route('berobat.store') }}" class="py-5 px-5" method="POST">
                    @csrf
                ...
                <div class="grid md:grid-cols-3">
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="text" name="nama" class="rounded-lg w-full focus:ring-2 shadow-sm">
                        </div>
                        @if ($errors->has('nama'))
                    ...
                    <div class="md:mx-2 max-sm:mt-2">
                        ...
                        <div class="mt-2 flex">
                            <input type="number" name="umur" class="rounded-lg w-full focus:ring-2 shadow-sm">
                    ...
                    <div class="max-sm:mt-2">
                        ...
                        <div class="mt-2">
                            <input type="text" name="nama_ortu" class="rounded-lg w-full focus:ring-2 shadow-sm">
                        </div>
                        @error('nama_ortu')
                            <div class="text-red-500">{{ $message }}</div>
                        @enderror
                ...
                <div class="grid grid-cols-2">
                    <div class="mt-3">
                        ...
                        <div class="mt-2">
                            <textarea name="pemeriksaan_fisik" id="" rows="4" class="w-full"></textarea>
                        </div>
                ...
                <div class="item-center justify-end flex">
                    <button type="submit" class="bg-green-500 py-2 px-3 rounded-lg mt-5 text-white shadow-lg">Tambah Data</button>
                </div>
                </form>
